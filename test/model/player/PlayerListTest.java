...
public class PlayerListTest {
    ...
    @Test
    @DisplayName("Adding new Model.player and removing it should equal to 0 size total")
    ...
    @Test
    @DisplayName("Creating a new Model.player should list the active Model.player as the same as the first Model.player from the list")
