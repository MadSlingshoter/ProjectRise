...
public class Menu extends JPanel {
	...
	private CombineGamePanels combineGamePanels;
	
	/**
	 * Constructor which draws the gui and sets music reference.
	 * Updated 2022-02-04 by Marcus Juninger to fix bug B2 with music.
	 * @param music
	 * @param combineGamePanels
	 */
	public Menu(BackgroundMusic music, CombineGamePanels combineGamePanels) {
		this.music = music;
		this.combineGamePanels = combineGamePanels;
	...
	public void restartGame() {
		combineGamePanels.Dispose(); // closes current CombineGamePanels
